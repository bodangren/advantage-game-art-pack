...
| 2026-04-09 | scene_layout_background_assembler_20260405 | Scene assembler schema is defined but no approved tiles or props exist for library_room/ruins_courtyard templates yet. | Medium | Closed | Sample manifests created in programs/scene/. Schema validated and deterministic. Actual primitive images still needed for visual output. |
