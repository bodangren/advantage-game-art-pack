...
- (2026-04-13, scene_layout_background_assembler_20260405) Per-pixel Python loops for image passes are a performance cliff at canvas scale; prefer PIL `ImageEnhance`/`ImageChops` or numpy masked ops, and verify each directional branch doesn't double-apply to overlapping regions.
