...
- (2026-05-09, e2e_llm_asset_pipeline) When adding CLI subcommands that import heavy modules (planner, orchestrator), import inside the command handler to avoid slow startup for other subcommands.
