...
- (2026-05-02, directional_character_sheets_20260502) Style pack directional_variants: nested dict with direction keys (N/S/E/W) mapping part_name to variant_id; empty {} is valid. DirectionalSheetProgram.render_spec is optional (nullable); check for None. `asf compile` already handles directional_sheet via generic dispatch — no new subcommand needed.
