...
## Goals
- Produce one canonical "golden" demo asset per family (character_sheet, effect_sheet, tileset, scene, cover_surface, loading_surface, ui_sheet, directional_sheet, projectile, pickup)
...
## Acceptance Criteria
- [ ] Demo asset source programs exist for all 10 families
